...
uint32_t CommunicationBuffer[ 1024 ];
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadStaticDef(CtrTask, CtrTask_Entry, osPriorityHigh, 0, 1024, CtrTaskBuffer, &CtrTaskControlBlock);
  ...
  osThreadStaticDef(Communication, CommunicationTask_Entry, osPriorityHigh, 0, 1024, CommunicationBuffer, &CommunicationControlBlock);
